 ...
 * 
 */
router.post("/assign", accountValidation.assign(), accountController.assign);
 ...
 *                           address: ""
 */
router.get("/dashboard", accountController.allAccounts);
 ...
 * 
 */
router.put("/editRole/:id", accountValidation.editRole(), accountController.editRole);
 ...
 * 
 */
router.put("/blockAccount/:id", accountController.blockAccount);
